...
export default function Card() {
    return (
        ...
        dark:bg-customNavy dark:border-gray-700">
            <a href="/">
                <img className="p-8 rounded-full" src="image/dp.png" alt="product_image1" />
            </a>
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                        ADITYA RAJ SINGH 
                        <h5 className='text-xl font-semibold tracking-tight text-gray-900 dark:text-customSky'>
                            FRONT-END DEVLOPER
                        </h5> 
                    </h5>
                </a>
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span>
                        <span className=" text-black text-l font-extrabold mr-2 px-3 py-0.5 rounded  dark:text-customSky ml-3">SKILLS</span>
                        <br />
